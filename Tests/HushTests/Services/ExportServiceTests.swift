...
final class ExportServiceTests: XCTestCase {
    ...
    func testFormatForClipboardWithSpeakersReturnsBodyOnlyWithoutHeaders() {
        let transcription = Transcription(
            ...
            speakers: [SpeakerInfo(id: "S1", label: "Alice"), SpeakerInfo(id: "S2", label: "Bob")],
            status: .completed
        )
        ...
        XCTAssertTrue(text.contains("Hello. Hi."))
        XCTAssertTrue(text.contains("Goodbye."))
